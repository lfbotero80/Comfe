...
Resumen navegable del repositorio para ubicar "¿dónde está X?" sin leer todo el código. Se actualiza en el mismo sprint en que el código cambia (ver `METODOLOGIA_SCRUM.md`). Última actualización: **2026-08-19**, tras `SPRINT-31`.
...
| `src/domain/dashboard-command.js` | Desde `SPRINT-31`. Capa de dominio del Dashboard de Mando: combina ocupacion/uso, presupuesto, cobertura de datos, fuente y bitacora para devolver filas priorizadas por sede, estado general de unidad, tendencia mensual, radar de perfil y datos para cuadrante. Evita que `dashboard.js` mezcle reglas de negocio con HTML. |
