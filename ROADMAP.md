...
**Siguientes sprints recomendados:** `SPRINT-31` debe implementar dominio de mando + banda + matriz por sede (`TO-HU-079/080`); `SPRINT-32` debe implementar cuadrante y top 3 acciones (`TO-HU-081/082`); `SPRINT-33` debe diferenciar la lectura anual de la mensual (`TO-HU-083` y TO-HU-061).
