...
**Siguientes sprints recomendados:** `SPRINT-32` debe profundizar el top 3 de acciones (`TO-HU-082`) con mejor relacion a bitacora/campanas; `SPRINT-33` debe diferenciar la lectura anual de la mensual (`TO-HU-083` y TO-HU-061).
